...
<head>
    ...
    <title>DAIICT-Community - <?php echo $fetched_user->getPropertyValue("username"); ?></title>
        ...
        <section id="second-section">
            <div id="second-part-left-panel">
                <div class="user-info-section row-v-flex">
                    <div class="user-info-section-link">
                        <div>
                ...
                <div id="posts-container">
                    <?php if(count($posts) == 0) { ?>
                        <div style="color:black" id="empty-posts-message">
                            ...
                            <p>click <a href="/chat/search.php" class="link" style="color: black">here</a> to go to the search page</p>
                        </div>
                    <?php } else { 
